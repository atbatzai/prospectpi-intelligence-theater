    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-navy-900 via-brand-purple-900 to-brand-navy-800">
      <Card className="w-full max-w-md p-8 space-y-6">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-600">Sign in to ProspectPI Intelligence Theater</p>
        </div>
        ...
        <div className="text-center text-sm text-gray-600">
          ...
          <Link href="/register" className="text-brand-purple-600 hover:text-brand-purple-700 font-medium">
            Create one
          </Link>
        </div>
      </Card>
